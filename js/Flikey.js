$(function(){
    ...
    $(function(){
    	$("#sendButton2").click(function() {
    		var params = "&meuserID=" + $("#meuserID2").val() +
            "&userID=" + $("#userID2").val() +
    ...
    $(function(){
    	$("#sendButton3").click(function() {
    		var params = "&meuserID=" + $("#meuserID3").val() +
            "&userID=" + $("#userID3").val() +
    ...
    $(function(){
    	$("#sendButton4").click(function() {
    		var params = "&meuserID=" + $("#meuserID4").val() +
            "&userID=" + $("#userID4").val() +
    ...
    $(function(){
    	$("#sendButton5").click(function() {
    		var params = "&meuserID=" + $("#meuserID5").val() +
            "&userID=" + $("#userID5").val() +
    ...
    $(function(){
    	$("#sendButton6").click(function() {
    		var params = "&meuserID=" + $("#meuserID6").val() +
            "&userID=" + $("#userID6").val() +
    ...
    $(function(){
    	$("#sendButton7").click(function() {
    		var params = "&meuserID=" + $("#meuserID7").val() +
            "&userID=" + $("#userID7").val() +
    ...
    $(function(){
    	$("#sendButton8").click(function() {
    		var params = "&meuserID=" + $("#meuserID8").val() +
            "&userID=" + $("#userID8").val() +
    ...
    $(function(){
    	$("#sendButton9").click(function() {
    		var params = "&meuserID=" + $("#meuserID9").val() +
            "&userID=" + $("#userID9").val() +
